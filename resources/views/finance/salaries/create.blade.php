    ...
    <form method="POST" action="{{ route('salaries.store') }}">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input name="base_salary" class="form-control" value="{{ old('base_salary') }}">
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">المكافأة</label>
                <input name="bonus" class="form-control" value="{{ old('bonus', 0) }}">
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">الاستقطاعات</label>
                <input name="deductions" class="form-control" value="{{ old('deductions', 0) }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input name="net_salary" class="form-control" value="{{ old('net_salary') }}">
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">الشهر</label>
                <input type="number" name="month" min="1" max="12" class="form-control" value="{{ old('month', now()->month) }}">
            </div>
            <div class="col-md-4 mb-3">
                <label class="form-label">السنة</label>
                <input type="number" name="year" min="2000" class="form-control" value="{{ old('year', now()->year) }}">
            </div>
        </div>
